...
class PhaseDetailScreen: UIView {
    ...
    lazy var gamesTableView: UITableView = {
        ...
        tableView.register(PhaseDetailTableViewCell.self, forCellReuseIdentifier: PhaseDetailTableViewCell.identifier)
        return tableView
    }()
